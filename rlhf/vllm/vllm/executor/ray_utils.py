            ...
            if isinstance(output, IntermediateTensors):
                if len(scheduler_output.scheduled_new_reqs) > 0:
                    ...
                    for scheduled_new_req in scheduler_output_t.scheduled_new_reqs:
                        ...
                        # scheduled_new_reqs.prompt_token_ids = []
                    # if scheduler_output.scheduled_cached_reqs.num_reqs > 0:
                    #     scheduler_output_t.scheduled_cached_reqs.new_token_ids = []
                    #     scheduler_output_t.scheduled_cached_reqs.num_computed_tokens = []
                else:
