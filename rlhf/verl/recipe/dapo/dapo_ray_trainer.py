                ...
                with marked_timer("step", timing_raw):
                    ...
                    with marked_timer("reward", timing_raw, "yellow"):
                        ...
                        try:
                            ...
                            delete_set_mllm = reward_result.get("delete_set_mllm", {})
                        except Exception as e:
                    ...
                    if len(delete_set_mllm) > 0:
                        assert self.config.algorithm.filter_groups.enable, f"如果使用了多模态文本相关数据删除代码，必须开启重要性采样"
                    ...
                    if not self.config.algorithm.filter_groups.enable:
                        ...
                        if len(delete_set_mllm) > 0:
                            for idel_mllm_uid in delete_set_mllm:
                                assert  idel_mllm_uid not in kept_prompt_uids, f"使用了多模态文本相关数据删除代码，但是重要性采样没有剔除成功"
