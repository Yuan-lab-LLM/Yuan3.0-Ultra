...
def parse_args():
    ...
    merge_parser.add_argument(
        "--vit_dir", default="tmp", type=str, help="Directory to save the merged huggingface model"
    )
    merge_parser.add_argument(
    ...
    merge_parser.add_argument(
        "--load_mode", default="total", type=str, help="load mode is total or split"
    )
...
class BaseModelMerger(ABC):
    ...
    def get_transformers_auto_model_class(self):
        ...
        # mengqiu modify
        elif "YuanVLChatModel" in self.model_config.architectures[0]:
