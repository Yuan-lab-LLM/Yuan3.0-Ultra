...
class BaseCheckpointManager:
    ...
    def __init__(
        ...
        self.checkpoint_load_mode = checkpoint_config.get("load_mode", 'total') if checkpoint_config else None
        checkpoint_save_contents = checkpoint_config.get("save_contents", None) if checkpoint_config else None
        self.checkpoint_save_mode = checkpoint_config.get("save_mode", 'total') if checkpoint_config else None
