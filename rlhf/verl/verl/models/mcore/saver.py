...
def _megatron_calc_global_rank(
    tp_rank: int = 0, dp_rank: int = 0, pp_rank: int = 0, cp_rank: int = 0, ep_rank: int = 0, use_ep=False
):
    ...
    assert dp_size % ep_size == 0, f'dp_size {dp_size}, ep_size {ep_size}'
    ddp_size = dp_size // ep_size
...
def merge_megatron_ckpt_gptmodel_yuan(
    wrapped_models, config, dtype, is_value_model=False, tie_word_embeddings=False
):
    raise NotImplementedError("merge_megatron_ckpt_gptmodel_yuan is not implemented")


def merge_megatron_ckpt_gptmodel_yuan_vl(
    wrapped_models, config, dtype, is_value_model=False, tie_word_embeddings=False
):
    raise NotImplementedError("merge_megatron_ckpt_gptmodel_yuan_vl is not implemented")
