...
_CHECKPOINT_FOR_DOC = "YuanLab/Yuan_Ultra"
...
class YuanForCausalLM(YuanPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> model = YuanForCausalLM.from_pretrained("YuanLab/Yuan_Ultra")
        >>> tokenizer = AutoTokenizer.from_pretrained("YuanLab/Yuan_Ultra")
