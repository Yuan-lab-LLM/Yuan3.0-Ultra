...
for ckpt_name in ckpt_list:
    for file_name in file_list:
        ...
        input = rf'/mnt/beegfs/suntianxing/result1/shotcot/text2sql/split/dev_{file_name}.jsonl'
        output = rf'/mnt/beegfs/suntianxing/result1/shotcot/text2sql/split/dev_{file_name}_clear.jsonl'
